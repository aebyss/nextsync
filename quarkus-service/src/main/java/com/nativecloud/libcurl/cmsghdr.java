...
public class cmsghdr {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        curl_wrapper_h.C_LONG.withName("cmsg_len"),
        curl_wrapper_h.C_INT.withName("cmsg_level"),
        curl_wrapper_h.C_INT.withName("cmsg_type"),
        MemoryLayout.sequenceLayout(0, curl_wrapper_h.C_CHAR).withName("__cmsg_data")
    ).withName("cmsghdr");
