...
public class msghdr {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        curl_wrapper_h.C_POINTER.withName("msg_name"),
        curl_wrapper_h.C_INT.withName("msg_namelen"),
        MemoryLayout.paddingLayout(4),
        curl_wrapper_h.C_POINTER.withName("msg_iov"),
        curl_wrapper_h.C_LONG.withName("msg_iovlen"),
        curl_wrapper_h.C_POINTER.withName("msg_control"),
        curl_wrapper_h.C_LONG.withName("msg_controllen"),
        curl_wrapper_h.C_INT.withName("msg_flags"),
        MemoryLayout.paddingLayout(4)
    ).withName("msghdr");
