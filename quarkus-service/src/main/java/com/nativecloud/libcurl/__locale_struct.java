...
public class __locale_struct {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(13, curl_wrapper_h.C_POINTER).withName("__locales"),
        curl_wrapper_h.C_POINTER.withName("__ctype_b"),
        curl_wrapper_h.C_POINTER.withName("__ctype_tolower"),
        curl_wrapper_h.C_POINTER.withName("__ctype_toupper"),
        MemoryLayout.sequenceLayout(13, curl_wrapper_h.C_POINTER).withName("__names")
