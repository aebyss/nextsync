...
public class __pthread_rwlock_arch_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        curl_wrapper_h.C_INT.withName("__readers"),
        curl_wrapper_h.C_INT.withName("__writers"),
        curl_wrapper_h.C_INT.withName("__wrphase_futex"),
        curl_wrapper_h.C_INT.withName("__writers_futex"),
        curl_wrapper_h.C_INT.withName("__pad3"),
        curl_wrapper_h.C_INT.withName("__pad4"),
        curl_wrapper_h.C_INT.withName("__cur_writer"),
        curl_wrapper_h.C_INT.withName("__shared"),
        curl_wrapper_h.C_CHAR.withName("__rwelision"),
        MemoryLayout.sequenceLayout(7, curl_wrapper_h.C_CHAR).withName("__pad1"),
        curl_wrapper_h.C_LONG.withName("__pad2"),
        curl_wrapper_h.C_INT.withName("__flags"),
