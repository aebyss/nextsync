...
public class tm {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        curl_wrapper_h.C_INT.withName("tm_sec"),
        curl_wrapper_h.C_INT.withName("tm_min"),
        curl_wrapper_h.C_INT.withName("tm_hour"),
        curl_wrapper_h.C_INT.withName("tm_mday"),
        curl_wrapper_h.C_INT.withName("tm_mon"),
        curl_wrapper_h.C_INT.withName("tm_year"),
        curl_wrapper_h.C_INT.withName("tm_wday"),
        curl_wrapper_h.C_INT.withName("tm_yday"),
        curl_wrapper_h.C_INT.withName("tm_isdst"),
        MemoryLayout.paddingLayout(4),
        curl_wrapper_h.C_LONG.withName("tm_gmtoff"),
        curl_wrapper_h.C_POINTER.withName("tm_zone")
    ).withName("tm");
