...
public class sockaddr_storage {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        curl_wrapper_h.C_SHORT.withName("ss_family"),
        MemoryLayout.sequenceLayout(118, curl_wrapper_h.C_CHAR).withName("__ss_padding"),
        curl_wrapper_h.C_LONG.withName("__ss_align")
