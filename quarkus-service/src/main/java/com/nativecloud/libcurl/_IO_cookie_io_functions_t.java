...
public class _IO_cookie_io_functions_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        curl_wrapper_h.C_POINTER.withName("read"),
        curl_wrapper_h.C_POINTER.withName("write"),
        curl_wrapper_h.C_POINTER.withName("seek"),
        curl_wrapper_h.C_POINTER.withName("close")
