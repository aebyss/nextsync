...
public class __pthread_mutex_s {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        curl_wrapper_h.C_INT.withName("__lock"),
        curl_wrapper_h.C_INT.withName("__count"),
        curl_wrapper_h.C_INT.withName("__owner"),
        curl_wrapper_h.C_INT.withName("__nusers"),
        curl_wrapper_h.C_INT.withName("__kind"),
        curl_wrapper_h.C_SHORT.withName("__spins"),
        curl_wrapper_h.C_SHORT.withName("__elision"),
