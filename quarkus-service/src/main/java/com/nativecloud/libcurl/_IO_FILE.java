...
public class _IO_FILE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        curl_wrapper_h.C_INT.withName("_flags"),
        MemoryLayout.paddingLayout(4),
        curl_wrapper_h.C_POINTER.withName("_IO_read_ptr"),
        curl_wrapper_h.C_POINTER.withName("_IO_read_end"),
        curl_wrapper_h.C_POINTER.withName("_IO_read_base"),
        curl_wrapper_h.C_POINTER.withName("_IO_write_base"),
        curl_wrapper_h.C_POINTER.withName("_IO_write_ptr"),
        curl_wrapper_h.C_POINTER.withName("_IO_write_end"),
        curl_wrapper_h.C_POINTER.withName("_IO_buf_base"),
        curl_wrapper_h.C_POINTER.withName("_IO_buf_end"),
        curl_wrapper_h.C_POINTER.withName("_IO_save_base"),
        curl_wrapper_h.C_POINTER.withName("_IO_backup_base"),
        curl_wrapper_h.C_POINTER.withName("_IO_save_end"),
        curl_wrapper_h.C_POINTER.withName("_markers"),
        curl_wrapper_h.C_POINTER.withName("_chain"),
        curl_wrapper_h.C_INT.withName("_fileno"),
        curl_wrapper_h.C_INT.withName("_flags2"),
        curl_wrapper_h.C_LONG.withName("_old_offset"),
        curl_wrapper_h.C_SHORT.withName("_cur_column"),
        curl_wrapper_h.C_CHAR.withName("_vtable_offset"),
        MemoryLayout.sequenceLayout(1, curl_wrapper_h.C_CHAR).withName("_shortbuf"),
        MemoryLayout.paddingLayout(4),
        curl_wrapper_h.C_POINTER.withName("_lock"),
        curl_wrapper_h.C_LONG.withName("_offset"),
        curl_wrapper_h.C_POINTER.withName("_codecvt"),
        curl_wrapper_h.C_POINTER.withName("_wide_data"),
        curl_wrapper_h.C_POINTER.withName("_freeres_list"),
        curl_wrapper_h.C_POINTER.withName("_freeres_buf"),
        curl_wrapper_h.C_LONG.withName("__pad5"),
        curl_wrapper_h.C_INT.withName("_mode"),
        MemoryLayout.sequenceLayout(20, curl_wrapper_h.C_CHAR).withName("_unused2")
    ).withName("_IO_FILE");
